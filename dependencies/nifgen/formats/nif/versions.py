...
def get_game(context):
	...
	if is_v10_2_0_0(context):
		return [games.PRO_CYCLING_MANAGER, games.PRISON_TYCOON, games.RED_OCEAN, games.WILDLIFE_PARK_2, games.CIVILIZATION_IV, games.LOKI, games.ZONE4]
...
def set_game(context, game):
	...
	if game in {games.PRO_CYCLING_MANAGER, games.RED_OCEAN, games.WILDLIFE_PARK_2, games.PRISON_TYCOON, games.ZONE4}:
...
v10_2_0_0 = NifVersion(id='V10_2_0_0', num=(167903232,), user=(0,), primary_games=[games.PRO_CYCLING_MANAGER, games.PRISON_TYCOON, games.RED_OCEAN, games.WILDLIFE_PARK_2, games.ZONE4], all_games=[games.PRO_CYCLING_MANAGER, games.PRISON_TYCOON, games.RED_OCEAN, games.WILDLIFE_PARK_2, games.CIVILIZATION_IV, games.LOKI, games.ZONE4])
